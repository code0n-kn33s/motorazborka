...
export const AsyncModalDevice = (props) => {
  ...
  useEffect(() => {
    if (isNew) {
      ...
      setIsCheckedDate(modalContent?.yearId);
    }
  ...
  const handleOk = () => {
    ...
    if (isNew) {
      dispatch(addRasborka(sendFiedls));
    } else {
      dispatch(editRozborka({ ...sendFiedls, id: modalContent.id }));
    }
    ...
    const handleKeyPress = (event) => {
      if (event.key === "Enter") {
        ...
        if (
          ...
          // Prevent the modal from closing if the focused element is an input field
          return;
        }
        handleOk();
      }
            ...
            <div className="content-block">
              <div className="content-block-left">
                ...
                <label
                  ...
                  label="Заголовок деталi"
                  name="username"
                >
                  <span>Заголовок деталi</span>
                  <br />
                  <Input
                ...
                >
                  <span>
                    Цiна деталi <b style={{ color: "orange" }}>*</b>
                  </span>
                  <br />
                  <InputNumber
                ...
                <label
                  className="input-label-item"
                  label="Додаткова iнформацiя"
                  name="username"
                  rules={[{ required: false }]}
                >
                  <span>Додаткова iнформацiя</span>
                  <br />
              ...
              <div className="modal-content-image">
                ...
                <label
                  className="input-label-item"
                  label="Виберiть тип деталi"
                  name="username"
                  rules={[{ required: true }]}
                >
                  <span>
                    Виберiть тип деталi <b style={{ color: "red" }}>*</b>
                  </span>
                  <br />
                ...
                <label
                  className="input-label-item"
                  label="Виберiть марку мотоциклу"
                  name="username"
                  rules={[{ required: true }]}
                >
                  <span>
                    Виберiть марку мотоциклу <b style={{ color: "red" }}>*</b>
                  </span>
                  <br />
                ...
                <label
                  className="input-label-item"
                  label="Виберiть моделi"
                  name="username"
                  rules={[{ required: false }]}
                >
                  <span>Виберiть моделi </span>
                  <br />
